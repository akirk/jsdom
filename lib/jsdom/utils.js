...
if (typeof __webpack_is_included__ === "function") { // Available in Webpack 5.0.16+
  // Check for an installed canvas without a Webpack error message.
  canvasInstalled = __webpack_is_included__("canvas");
} else {
  try {
